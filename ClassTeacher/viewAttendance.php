...
<head>
  ...
  <link href="img/logo/attlng.png" rel="icon">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                    ...
                    if(isset($_POST['view'])){
                      ...
                      where tblattendance.dateTimeTaken = '$dateTaken' and tblattendance.classId = '$_SESSION[classId]' and tblattendance.classArmId = '$_SESSION[classArmId]' ORDER BY tblstudents.admissionNumber ASC";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                      $sn=0;
                      $status="";
